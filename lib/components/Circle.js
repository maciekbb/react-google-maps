...
var Circle = (exports.Circle = (function(_React$PureComponent) {
  ...
  function Circle(props) {
    ...
    _this.state = (0, _defineProperty3.default)({}, _constants.CIRCLE, null)
    return _this
  }
  ...
  ;(0, _createClass3.default)(Circle, [
    {
      ...
      value: function componentDidMount() {
        ...
        circle.setMap(this.context[_constants.MAP])
        ;(0, _MapChildHelper.componentDidMount)(this, circle, eventMap)
        this.setState(
          (0, _defineProperty3.default)({}, _constants.CIRCLE, circle)
        )
      },
    },
    {
...
Circle.contextType = _MapContext2.default
