...
var Polygon = (exports.Polygon = (function(_React$PureComponent) {
  ...
  function Polygon(props) {
    ...
    _this.state = (0, _defineProperty3.default)({}, _constants.POLYGON, null)
    return _this
  }
  ...
  ;(0, _createClass3.default)(Polygon, [
    {
      ...
      value: function componentDidMount() {
        ...
        polygon.setMap(this.context[_constants.MAP])
        ;(0, _MapChildHelper.componentDidMount)(this, polygon, eventMap)
        this.setState(
          (0, _defineProperty3.default)({}, _constants.POLYGON, polygon)
        )
      },
    },
    {
...
Polygon.contextType = _MapContext2.default
