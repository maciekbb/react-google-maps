...
var Polyline = (exports.Polyline = (function(_React$PureComponent) {
  ...
  function Polyline(props) {
    ...
    _this.state = (0, _defineProperty3.default)({}, _constants.POLYLINE, null)
    return _this
  }
  ...
  ;(0, _createClass3.default)(Polyline, [
    {
      ...
      value: function componentDidMount() {
        ...
        polyline.setMap(this.context[_constants.MAP])
        ;(0, _MapChildHelper.componentDidMount)(this, polyline, eventMap)
        this.setState(
          (0, _defineProperty3.default)({}, _constants.POLYLINE, polyline)
        )
      },
    },
    {
...
Polyline.contextType = _MapContext2.default
