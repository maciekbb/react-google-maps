...
var Marker = (function(_React$PureComponent) {
  ...
  function Marker(props) {
    ...
    _this.state = (0, _defineProperty3.default)({}, _constants.MARKER, null)
    return _this
  }
  ...
  ;(0, _createClass3.default)(Marker, [
    {
      ...
      value: function componentDidMount() {
        ...
        ;(0, _MapChildHelper.componentDidMount)(this, marker, eventMap)
        this.setState(
          (0, _defineProperty3.default)({}, _constants.MARKER, marker)
        )
      },
    },
    {
...
Marker.contextType = _MapContext2.default
