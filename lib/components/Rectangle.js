...
var Rectangle = (exports.Rectangle = (function(_React$PureComponent) {
  ...
  function Rectangle(props) {
    ...
    _this.state = (0, _defineProperty3.default)({}, _constants.RECTANGLE, null)
    return _this
  }
  ...
  ;(0, _createClass3.default)(Rectangle, [
    {
      ...
      value: function componentDidMount() {
        ...
        rectangle.setMap(this.context[_constants.MAP])
        ;(0, _MapChildHelper.componentDidMount)(this, rectangle, eventMap)
        this.setState(
          (0, _defineProperty3.default)({}, _constants.RECTANGLE, rectangle)
        )
      },
    },
    {
...
Rectangle.contextType = _MapContext2.default
